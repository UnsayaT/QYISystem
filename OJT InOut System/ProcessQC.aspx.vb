...
Public Class ProcessQC
    ...
    Protected Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        Dim ret, lot, Op_No, strSQLQYI, strSQLLY, strSQLIC, strSQLUpcase, strSQLTranLot, strSQLBackupNo As String
        Dim dtAdapterQYI, dtAdapterLY, dtAdapterIC, dtTranLot, dtBackupNo As SqlDataAdapter
        Dim dtQYI, dtLY, dtIC, dtNo, dtEmp, dtLotID, dtBackup As New DataTable
   ...
   where lot_no='" & txtLotno.Text & "' and name='AUTO(4)'"
            ...
            Try
                ...
                If dtQYI.Rows.Count > 0 Then
                    ...
                    strSQLUpcase = "UPDATE [DBx].[QYI].[QYICase] SET QCInCharge = '" & txtEmpNo.Text & "' " &
                    " ,QCTimeInput = '" & Now() & "' ,QCJugdement = '" & Session("GOto") & "',UserIDOut='" & txtEmpNo.Text & "',TimeOut='" & Now() & "' Where No ='" & Session("QYINo") & "'"
                    ...
                    " ,QCTimeInput = '" & Now() & "' ,QCJugdement = '" & Session("GOto") & "',UserIDOut='" & txtEmpNo.Text & "',TimeOut='" & Now() & "' Where No ='" & Session("QYINo") & "'"
                        ...
                        'My.Computer.FileSystem.CreateDirectory("\\172.16.0.115/NewCenterPoint/QYI/QC/" & txtLotno.Text & "")
                        Response.Redirect("UploadFileQC.aspx")
                    Else
