    ...
    Protected Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        ...
        If RadioButton3.Checked = True Then
            ...
            Try
                ...
                If dtQYI.Rows.Count > 0 Then
                    ...
                    " ,TimeOut = '" & Now() & "' ,GotoProcess = '" & Session("GOto") & "',OSNG1='" & Session("NG") & "' Where No ='" & Session("QYINo") & "'"
        ...
        ElseIf RadioButton1.Checked = True Then
            ...
            If dtQYI.Rows.Count > 0 Then
                Session("QYINo") = dtQYI.Rows(0)("No")
                'Update ข้อมูลลงใน QYICase
                strSQLUpcase = "UPDATE [DBx].[QYI].[QYICase] SET GotoProcess = 'QC' ,OSNG1='" & Session("NG") & "' Where No ='" & Session("QYINo") & "' "
                objCmd = New SqlCommand(strSQLUpcase, objConn)
                objCmd.ExecuteNonQuery()
            End If
