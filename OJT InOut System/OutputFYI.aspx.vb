...
Public Class OutputFYI
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        'Check Lot No ใน QYI
        strSQLLot = "Select Top(1) No,LotNo,OSNG1,OSNG2,GotoProcess,Mode,UserIDIn,UserIDIn2,UserIDOut,UserIDOut2,Remark1,OldDeviceName,OldPackage,TimeOut From [DBx].[QYI].[QYICase] Where LotNo ='" & txtLotno.Text & "' and Mode IS Not NULL order By TimeIn DESC"
